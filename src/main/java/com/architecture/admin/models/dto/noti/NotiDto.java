...
public class NotiDto {
    ...
    // puppycat_member_notification
    private long idx;           // 고유 번호
    private String memberUuid;  // 회원 고유값
    ...
    // puppycat_member_notification_show
    ...
    // 기타
    private List<Long> mentionMemberIdxList; // 멘션 회원 리스트
    private Integer contentsLikeState;       // 컨텐츠 좋아요 여부
    private Integer followState;             // 팔로우 여부
    private List<String> memberUuidList;     // 회원 uuid 리스트 (공통)
    private String startDate;                   // 날짜 검색 조건
    private String endDate;                     // 날짜 검색 조건
